...
class StrategyRocPortfolio(StrategyBase):
    def __init__(self):
        self.inds = {}
...
if __name__ == '__main__':
    ...
    e = BacktraderEngine(start=datetime(2015, 1, 1), end=datetime(2022, 12, 31))
    for code in ['511220.SH', '512010.SH', '518880.SH', '163415.SZ', '159928.SZ', '161903.SZ', '513100.SH']:
        e.add_arctic_data(code)

    e.cerebro.addstrategy(StrategyRocPortfolio)
    e.run()
